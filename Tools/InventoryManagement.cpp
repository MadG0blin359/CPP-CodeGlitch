...
int main() {
    ...
    const int size = 10;        // Fixed Size for items array
    Inventory item[size];       // Array object of class
    ...
    do {
        ...
        switch(menu_choice) {
            case '1':
                ...
                cin >> numOfItems; 
                item[numOfItems];          // Adjusting the array size according to the user needs
