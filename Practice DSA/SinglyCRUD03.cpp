...
//}
//
//bool List::removeDuplicates() {
//	// When the list is empty or has only one node
...
//	Node* current = head;
//
//	// Traverse through each node with 'current'
//	while (current != NULL) {
...
//				// Duplicate node found, so delete it
//				Node* duplicate = nextNode->next;
//				nextNode->next = duplicate->next;  // Skip the duplicate node
//				delete duplicate;  // Free the memory of duplicate node
//			}
//			else {
